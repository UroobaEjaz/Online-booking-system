...
//
//    public Users addUser( int userId, String name, String password, String role, Date dateOfJourney, List<Trains> trains){
//        Users user = new Users();
//        user.setUserId(userId);
//        user.setName(name);
//        user.setPassword(password);
//        user.setRole(role);
//        user.setDateOfJourney(dateOfJourney);
//        user.setTrains(trains);
//        return  user;
//    }
//
